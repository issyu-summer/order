...
public class ChenYixinTest {
    ...
    public void shopsShopIdOrdersIdPut0() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48050")
        ...
        byte[] confirmString = mallClient.get().uri("/shops/406/orders/48050")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdPut1() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/4000000")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isNotFound()
    ...
    public void shopsShopIdOrdersIdPut2() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/1")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isForbidden()
    ...
    public void postFreights0() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48052/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/406/orders/48052")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void postFreights1() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/4000000/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isNotFound()
    ...
    public void postFreights2() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/1/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isForbidden()
    ...
    public void postFreights3() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48050/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights4() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48051/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights5() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48053/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights6() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48054/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights7() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48055/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights8() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48056/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void postFreights9() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/406/orders/48057/deliver")
                .header("authorization", token)
                .bodyValue(orderJson)
                .exchange()
                .expectStatus().isOk()
    ...
    public void shopsShopIdOrdersIdDelete0() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48050")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete1() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48051")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/406/orders/48051")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete2() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/4000000")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete3() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/1")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete4() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48052")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete5() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48053")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/406/orders/48053")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete6() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48054")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/406/orders/48054")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete7() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48055")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete8() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48056")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete9() throws Exception {
        ...
        String token = this.login("13088admin", "123456");
        byte[] responseString = mallClient.delete().uri("/shops/406/orders/48057")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
