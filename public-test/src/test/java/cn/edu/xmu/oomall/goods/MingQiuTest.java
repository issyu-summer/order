...
public class MingQiuTest {
    ...
    public void goodsTest1(){
        ...
        List<String> couponSn = JacksonUtil.parseStringList(new String(responseString), "data");
        ...
        couponSn = JacksonUtil.parseStringList(new String(responseString), "data");
        String couponSn12159_1 = couponSn.get(0);
        String couponSn12159_2 = couponSn.get(1);

        responseString = mallClient.get().uri("/coupons?state=1")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void goodsTest2() {
        ...
        mallClient.get().uri("/shops/1/couponactivities/12158")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        mallClient.get().uri("/shops/1/couponactivities/12159")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
