...
//        JSONAssert.assertEquals(expectedResponse, new String(ret, "UTF-8"), true);
    ...
    public void modifyPresaleofSKU1() throws Exception {
        ...
        //String token = createTestToken(1L, 1L, 100);
        String token = this.login("13088admin", "123456");
        String Json= "{\"name\":\"modifytest\",\"advancePayPrice\":100,\"restPayPrice\":200,\"quantity\":10,\"beginTime\":\"2020-12-20T15:55:18\",\"endTime\":\"2022-01-05T15:55:18\",\"payTime\":\"2021-12-20T15:55:18\"}";
...
//        JSONAssert.assertEquals(expectedResponse, new String(responseString, "UTF-8"), true);
    ...
    public void modifyPresaleofSKU2() throws Exception {
        //String token = createTestToken(1L, 1L, 100);
        String token = this.login("13088admin", "123456");
        String Json= "{\"name\":\"modifytest2\",\"advancePayPrice\":100,\"restPayPrice\":300,\"quantity\":299,\"beginTime\":\"2020-12-20T15:55:18\",\"endTime\":\"2022-01-05T15:55:18\",\"payTime\":\"2021-12-20T15:55:18\"}";
...
//        JSONAssert.assertEquals(expectedResponse, new String(responseString, "UTF-8"), true);
    ...
    public void modifyPresaleofSKU3() throws Exception {
        String token = this.login("13088admin", "123456");
        //String token = createTestToken(1L, 1L, 100);
        String Json= "{\"name\":\"modifytest3\",\"advancePayPrice\":333,\"restPayPrice\":222,\"quantity\":111,\"beginTime\":\"2020-12-20T15:55:18\",\"endTime\":\"2022-01-05T15:55:18\",\"payTime\":\"2021-12-20T15:55:18\"}";
