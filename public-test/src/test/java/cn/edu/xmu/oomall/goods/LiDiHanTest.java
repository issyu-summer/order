...
public class LiDiHanTest {
    ...
    public void createGrouponAc1() throws Exception {
        ...
        String json = "{\"beginTime\":\"2021-12-27T11:57:39\"," +
                "\"endTime\":\"2021-12-28T11:57:39\",\"strategy\":\"无\"}";
        byte[] ret = manageClient.post()
                ...
                .getResponseBodyContent();
        String responseString = new String(ret, "UTF-8");
        String expectedResponse = "{\"errno\":0,\"data\":{\"id\":6,\"name\":null}," +
                "\"errmsg\":\"成功\"}\n";
    ...
    public void changeGrouponAc1() throws Exception {
        String token = this.login("13088admin","123456");
        String json = "{\"beginTime\":\"2021-12-07T11:57:39\"," +
                "\"endTime\":\"2021-12-09T11:57:39\",\"strategy\":\"有\"}";
    ...
    public void getGrouponActivity1() throws Exception {
        ...
        String expectedString = "{\"errno\":0,\"data\":" +
                "{\"total\":3,\"pages\":1,\"pageSize\":3,\"page\":1," +
                "\"list\":[{\"id\":1,\"name\":\"双十一\"},{\"id\":3,\"name\":\"黑色星期五\"},{\"id\":5,\"name\":\"劳动节\"}]}," +
                "\"errmsg\":\"成功\"}\n";
    ...
    public void getGrouponActivity4() throws Exception {
        byte[] ret = mallClient.get()
                ...
                .getResponseBodyContent();
        String responseString = new String(ret, "UTF-8");
        String expectedString = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":2," +
    ...
    public void getShopGrouponAc1() throws Exception {
        ...
        byte[] ret = manageClient.get()
                .uri(uriBuilder -> uriBuilder.path("/shops/1/groupons")
                        ...
                        .queryParam("spuId",273L)
                        .queryParam("startTime","2020-12-22T11:57:39")
                        .queryParam("endTime","2020-12-31T11:57:39")
                        .build())
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
        ...
        String expectedResponse = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1," +
                "\"pageSize\":10,\"page\":1,\"list\":[{\"id\":2,\"name\":\"双十二\" }]}" +
                ",\"errmsg\":\"成功\"}\n";
        JSONAssert.assertEquals(expectedResponse, responseString, false);
    }
    ...
    public void getShopGrouponAc2() throws Exception {
        ...
        String responseString = new String(ret, "UTF-8");
        String expectedResponse = "{\"errno\":0,\"data\":{\"total\":1,\"pages\":1," +
                "\"pageSize\":10,\"page\":1,\"list\":[{\"id\":4,\"name\":\"儿童节\"}]}" +
                ",\"errmsg\":\"成功\"}\n";
        JSONAssert.assertEquals(expectedResponse, responseString, false);
    }
    ...
    public void getShopGrouponAc3() throws Exception {
        ...
        byte[] ret = manageClient.get()
                .uri(uriBuilder -> uriBuilder.path("/shops/1/groupons")
                        .queryParam("state",(byte) 0)
                        .queryParam("spuId",273L)
                        .queryParam("startTime","2020-12-01T11:57:39")
                        .build())
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                ...
                .getResponseBodyContent();
        String responseString = new String(ret, "UTF-8");
        String expectedResponse = "{\"errno\":0,\"data\":{\"total\":4,\"pages\":1," +
                "\"pageSize\":10,\"page\":1,\"list\":[{\"id\":1,\"name\":\"双十一\"},{\"id\":2,\"name\":\"双十二\"}" +
                ",{\"id\":3,\"name\":\"黑色星期五\"}," +
                "{\"id\":5,\"name\":\"劳动节\"}]}" +
                ",\"errmsg\":\"成功\"}\n";
        JSONAssert.assertEquals(expectedResponse, responseString, false);
