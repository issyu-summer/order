...
public class XuGengchenTest {
    ...
    public void postTimeTest1() throws Exception {
        ...
        String admintoken = this.adminlogin("13088admin", "123456");
        String roleJson = "{\"beginTime\": \"2020-11-28 21:10:27\",\"endTime\": \"2021-01-23 11:00:00\"}";
        byte[] responseString1 = manageClient.post().uri("/shops/10/advertisement/timesegments")
                .header("authorization", admintoken)
                .bodyValue(roleJson)
                .exchange()
        ...
        byte[] responseString2 = manageClient.get().uri("/shops/10/advertisement/timesegments")
                .header("authorization", admintoken)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        String expectedResponse2 = "{\"errno\":0,\"errmsg\":\"成功\"," +
                ...
                "\"list\":" +
                "[{\"id\":28," +
                "\"beginTime\":\"2020-11-28T21:10:27\","+
                "\"endTime\":\"2021-01-23T11:00:00\","+
    ...
    public void modifyTimeTest3() throws Exception {
        String admintoken = this.adminlogin("13088admin", "123456");
        byte[] responseString1 = manageClient.delete().uri("/shops/0/advertisement/timesegments/22")
                .header("authorization", admintoken)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] responseString2 = manageClient.get().uri("/shops/0/timesegments/22/advertisement")
                .header("authorization", admintoken)
                .exchange()
