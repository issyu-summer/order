...
public class HuJialeTest {
    ...
    public void insertAdTimeTest1() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "  \"data\": {\n" +
//                "    \"id\": 28,\n" +
                "    \"beginTime\": \"2020-12-15T07:30:00\",\n" +
                "    \"endTime\": \"2020-12-15T07:40:00\",\n" +
...
//                "        \"gmtCreate\": \"2020-12-15T16:15:09\",\n" +
    ...
    public void insertFsTimeTest1() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "  \"data\": {\n" +
//               "    \"id\": 29,\n" +
                "    \"beginTime\": \"2020-12-15T01:00:00\",\n" +
                "    \"endTime\": \"2020-12-15T01:01:00\",\n" +
...
//                "        \"gmtCreate\": \"2020-12-15T19:43:08\",\n" +
    ...
    public void deleteFsTimeTest1() throws Exception {
        ...
        byte[] responseString = manageClient.delete().uri("/shops/0/flashsale/timesegments/8").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .returnResult()
        ...
        //重新查询进行验证
        byte[] responseString2 = manageClient.get().uri("/shops/0/flashsale/timesegments?page=1&pageSize=1").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .returnResult()
