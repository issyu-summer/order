...
public class LiHanTest {
    ...
    public void defPieceFreightModelRule() throws Exception {
        ...
        manageClient
                .post()
                .uri("/shops/7/freightmodels/284801411/pieceItems")
                .header("authorization",token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isCreated()
    ...
    public void shopEditOrder() throws Exception {
        ...
        byte[] confirmString = manageClient.get().uri("/shops/7/orders/19720182203919")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopGetOrderPayment() throws Exception {
        ...
        byte[] responseBytes = manageClient
                .get()
                .uri("/shops/7/orders/19720182203919/payments")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopGetOrderPaymentNoAuth() throws Exception {
        ...
        byte[] responseBytes = manageClient
                .get()
                .uri("/shops/7/orders/19720182203923/payments")
                .header("authorization", token)
                .exchange()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_OUTSCOPE.getCode())
    ...
    public void shopGetOrderPaymentNoOrder() throws Exception {
        ...
        byte[] responseBytes = manageClient
                .get()
                .uri("/shops/7/orders/19720182203928/payments")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void customerGetOrderPayment() throws Exception {
        // userId = 2668
        String token = this.genToken(2668L, -2L, Integer.MAX_VALUE);
    ...
    public void customerGetOrderPaymentNoAuth() throws Exception {
        ...
        byte[] responseBytes = mallClient
                .get()
                .uri("/orders/19720182203924/payments")
                .header("authorization", token)
                .exchange()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_OUTSCOPE.getCode())
    ...
    public void createPaymentOverflow() throws Exception {
        // userId = 7768
        String token = this.genToken(7768L, -2L, Integer.MAX_VALUE);
        String body = "{\n" +
                "  \"price\": 99999999,\n" +
                "  \"paymentPattern\": \"002\"\n" +
                "}";
