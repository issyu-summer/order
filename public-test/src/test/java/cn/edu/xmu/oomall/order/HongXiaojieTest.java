...
public class HongXiaojieTest {
    ...
    public void createPaymentTestByAftersaleId() throws Exception{
        ...
        String paymentJson = "{\n" +
                ...
                "    \"paymentPattern\": \"002\"\n" +
                "}";
        byte[] responseString = manageClient.post().uri("/aftersales/{id}/payments",47008)
    ...
    public void customerQueryPaymentByAftersaleId() throws Exception{
        ...
        byte[] responseString = manageClient.get().uri("/aftersales/{id}/payments",47011)
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void customerQueryPaymentByAftersaleId2() throws Exception{
        ...
        byte[] responseString = manageClient.get().uri("/aftersales/{id}/payments",47989)
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void userQueryPaymentTest() throws Exception{
        String token = userLogin("44357456028", "123456");
        byte[] responseString=manageClient.get().uri("/orders/{id}/payments",47123)
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void userQueryPaymentTest2() throws Exception{
        String token = userLogin("44357456028", "123456");
        byte[] responseString=manageClient.get().uri("/orders/{id}/payments",48230)
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    /**
     * 管理员查询订单的支付信息，success
     * @author 洪晓杰
     */
    @Test
    public void queryPaymentTest1() throws Exception{
        String token = userLogin("44357456028", "123456");
        byte[] responseString=manageClient.get().uri("/shops/{shopId}/orders/{id}/payments",57101,47123)
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void queryPaymentTest2() throws Exception{
        String token = this.login("13088admin", "123456");
        byte[] responseString=manageClient.get().uri("/shops/{shopId}/orders/{id}/payments",57101,48223)
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void createPaymentTest() throws Exception{
        ...
        String paymentJson = "{\n" +
                ...
                "    \"paymentPattern\": \"002\"\n" +
                "}";
        byte[] responseString = manageClient.post().uri("/orders/{id}/payments",47123)
                .header("authorization", token)
                .bodyValue(paymentJson)
                .exchange()
                .expectStatus().isCreated()
    ...
    @Test
    @Order(16)
    public void insertPieceFreightModelTest5()  throws Exception{
        String token = this.login("13088admin", "123456");
    ...
    public void updateOrderForCustomer()throws Exception{
        ...
        byte[] responseString = mallClient.put().uri("/orders/{id}/",47007)
                .header("authorization", token)
