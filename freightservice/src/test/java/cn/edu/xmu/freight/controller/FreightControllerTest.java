...
public class FreightControllerTest {
     ...
     */
    @Test
    public void postWeightItemsTest(){
        String token = createTestToken(1L,0L,100);
        String adressJson="{\"firstWeight\":0,\"firstWeightFreight\":0,\"tenPrice\"" +
                ":0,\"fiftyPrice\":0,\"hundredPrice\":0,\"trihunPrice\":0,\"abovePrice\":0,\"regionId\":0}";
        try{
